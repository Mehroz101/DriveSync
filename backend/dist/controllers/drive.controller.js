...
import { fetchUserProfile, fetchDriveAccountFiles } from "../services/drive.service.js";
export const getDriveFiles = async (req, res, next) => {
    try {
...
export const addDriveAccount = async (req, res, next) => {
    try {
        const userId = req.params.userId;
...
export const removeDriveAccount = async (req, res, next) => {
    try {
...
export const syncDriveFiles = async (req, res, next) => {
    try {
        const userId = req.params.userId;
        const user = await User.findById(userId);
        if (!user) {
